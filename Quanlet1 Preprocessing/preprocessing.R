...
Player_Attributes$attacking_work_rate = NULL  # dropped due to ambiguous levels
Player_Attributes$defensive_work_rate = NULL  # dropped due to ambiguous levels

# check if the player attribute records are consistently missing
...
Player_Attributes$preferred_foot_is_right = 
                          as.numeric(as.factor(Player_Attributes$preferred_foot)) - 1
