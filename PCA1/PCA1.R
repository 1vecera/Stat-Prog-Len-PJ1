PCA = function(table,
               ...
               order = 2,
               desiredvariance = 0.8)
  #default value of order is 2 (more convenient for plotting) , it's the maximal number of PC you want
{
  ...
  if (mean(check) == 1)
  {
    ...
    return(list(
      ...
      cum = cum,
      R = R
    )) #We return FF,G,cor,the inertia proportion and the correlation matrix
